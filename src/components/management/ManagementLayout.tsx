...
export function ManagementLayout({ children, title }: ManagementLayoutProps) {
        ...
        <main className="flex-1 overflow-auto">
          <header className="sticky top-0 z-10 h-14 flex items-center justify-between gap-4 border-b border-border/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4">
            <div className="flex items-center gap-4">
              ...
              <div className="px-2.5 py-1 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-medium">
                Management
              </div>
